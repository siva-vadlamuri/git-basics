...
class Signup extends Component {
  ...
  validateNumber = evt => {
    var theEvent = evt || window.event;//default parameter
  ...
  handleChange = (e) => {
    ...
    const { form, formErrors } = this.state;//destructuring
    //es5
  ...
  componentWillMount() {
    debugger;
    console.log('I am going to call before component rendered into DOM');
  }

  render() {
    //Es6 + way of destructing an object
    const { form, formErrors } = this.state;//Object Destructuring
    //Es5 way of destructing an object
